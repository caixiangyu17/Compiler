...
.method array([I[F)V
L0:
.var 0 is this Ltest/special; from L0 to L1
...
.var 1 is vc$ Ltest/special; from L0 to L1
	new test/special
	dup
	invokenonvirtual test/special/<init>()V
	astore_1
...
.var 3 is fc [F from L0 to L1
	...
	aload_2
	aload_3
	invokevirtual test/special/array([I[F)V
L1:
	return
	nop
